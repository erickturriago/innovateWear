...
import type { TShirtSize, PredesignedCartItem, CartItem } from '../models/CartItem'; // Ajustado para incluir CartItem genérico
...
const ProductDetailPage = () => {
    ...
    // --- CORRECCIÓN: Seleccionar acciones individualmente para evitar bucles ---
    ...
    const handleAddToCart = () => {
        ...
        // El tipo del item del carrito debe ser compatible con la definición en el store
        ...
        if (!user) {
            // Guardamos el item que el usuario quería añadir
            setPendingItem(cartItem as CartItem); // Hacemos un cast al tipo base
            // Notificamos y redirigimos
            showNotification('Debes iniciar sesión para añadir productos al carrito.', 'info');
            navigate('/login');
            return;
        }

        // Si hay usuario, la lógica continúa como antes
        addProductToCart(cartItem as CartItem);
